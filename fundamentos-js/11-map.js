...
é o resultado de um processamento do elemento correspondente do vetor original.
A transformação é processada pela função passada como parâmetro.O novo vetor
gerado por map() terá sempre o mesmo número de elementos do vetor original
 */
const numeros = [13, 19, 3, -4, 13, -11, 15, -1, 0]
const frutas = ['laranja', 'abacaxi', 'maça', 'uva', 'jabuticaba', 'maracujá']
//geando um novo vetor em que cada elemento corresponde ao valor do elemento original elevado ao quadrado
